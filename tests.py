...
@pytest.mark.parametrize('tested_string', ["Ivan Ivanov something 89112324509 12/11/1982",
...
@pytest.mark.parametrize('tested_string', ["Ivan 12/12/1312 89112324509 12/11/1982",
...
@pytest.mark.parametrize('tested_string', ["Ivan Ivanov 8911232459 12/11/1982",
...
def test_invalid_phone_num(tested_string):
    ...
    with open("file.txt") as file:
        arr = [row.strip() for row in file]
    assert functions.add(tested_string, arr) in ["Invalid phone number", "Invalid character in phone number"]
